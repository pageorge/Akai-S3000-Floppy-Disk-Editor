...
*/
/* Source: https://github.com/Midi-In/akaiutil/blob/master/akaiutil_file.h */
/* Copied here for reference — this is the canonical struct definition used */
/* to verify byte offsets in AkaiDiskImage.swift. */
...
#define PROGRAM1000KG_BLOCKID	0x02
	...
	u_char dummy2[3];    /* XXX */
                         /* NOTE: dummy2[1] and dummy2[2] = bytes at kg+0x20/0x21 */
                         /* Hardware expects 0xFFFF here — confirmed by byte-diff  */
                         /* against working programs on real S3000XL hardware.     */
